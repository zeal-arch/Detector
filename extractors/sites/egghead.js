(function () {
    ...
    function extractFromPage() {
        ...
        for (const script of scripts) {
            ...
            const lessonMatch = content.match(/"(?:lesson_url|videoUrl|dash_url|hls_url)"\s*:\s*"([^"]+)"/gi);
            if (lessonMatch) {
                for (const match of lessonMatch) {
    ...
    log('Egghead.io specialist initialized');
})();
