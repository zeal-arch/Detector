(function () {
    'use strict';
    console.log('[NBA Specialist] Loaded on:', window.location.href);
    ...
    function extractVideo() {
        try {
            ...
            for (const script of scripts) {
                ...
                const m3u8Match = content.match(/"(?:hlsUrl|videoUrl|streamUrl)":\s*"([^"]+\.m3u8[^"]*)"/);
                if (m3u8Match) {
            ...
            console.error('[NBA] Extraction error:', err);
        }
    }
